...
public class EntityRepositoryDeleteJdbcEntityTest {

    @TestExternal
    private EntityRepositoryInsertJdbcEntityTest entityRepositoryInsertEntityTest;
    ...
    public void test_userDelete() {
        ...
        SearchCriteria<EntityUser> searchCriteria = userRepository.beginCriteria()
                ...
                .andEquals(EntityUser::getFirstName, EntityRepositoryInsertJdbcEntityTest.ENTITY_USER.getFirstName());
