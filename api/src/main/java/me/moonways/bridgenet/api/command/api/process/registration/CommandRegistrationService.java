...
import me.moonways.bridgenet.api.command.CommandAccessKey;
import me.moonways.bridgenet.api.command.GeneralCommand;
import me.moonways.bridgenet.api.command.SubCommand;
import me.moonways.bridgenet.api.command.api.exception.CommandException;
import me.moonways.bridgenet.api.command.api.uses.Command;
import me.moonways.bridgenet.api.command.api.uses.CommandInfo;
import me.moonways.bridgenet.api.command.api.process.verification.inject.CommandAnnotationService;
import me.moonways.bridgenet.api.command.api.process.verification.inject.CommandReflectAnnotationContext;
...
public class CommandRegistrationService {
    ...
    private List<Command> createSubcommands(String generalCommandName, Bean bean, BeanMethod beanMethod) {
        ...
        return beanMethod.getAnnotation(SubCommand.class)
                ...
                .map(list -> list
                        .stream()
                        .map(alias -> createCommand(bean, beanMethod, compileFullAlias(generalCommandName, alias), accessKey))
    ...
    private String compileFullAlias(String generalCommandName, String subcommandName) {
