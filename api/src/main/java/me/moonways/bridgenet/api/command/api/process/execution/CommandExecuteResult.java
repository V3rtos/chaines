package me.moonways.bridgenet.api.command.api.process.execution;
...
public final class CommandExecuteResult {
    ...
    public static <T extends EntityCommandSender> CommandExecuteResult ok(T sender, Consumer<T> consumer) {
