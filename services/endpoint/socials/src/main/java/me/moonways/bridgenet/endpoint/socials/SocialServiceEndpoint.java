package me.moonways.bridgenet.endpoint.socials;
...
import me.moonways.bridgenet.endpoint.socials.api.type.telegram.TelegramLinkageApi;
import me.moonways.bridgenet.endpoint.socials.api.type.vkontakte.VkontakteLinkageApi;
import me.moonways.bridgenet.endpoint.socials.database.PlayerSocialData;
import me.moonways.bridgenet.endpoint.socials.database.SocialDbRepository;
...
public class SocialServiceEndpoint extends EndpointRemoteObject implements SocialsServiceModel {
    ...
    public CompletableFuture<SocialBindingResult> tryUnlink(UUID playerId, Social social) throws RemoteException {
        ...
        return linkageApi.unlink(socialLink)
